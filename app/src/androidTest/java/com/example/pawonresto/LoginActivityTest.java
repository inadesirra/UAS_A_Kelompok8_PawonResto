...
public class LoginActivityTest {
    ...
    public void loginActivityTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.loginEmail),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("salah"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.loginPassword),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("salah"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.loginEmail), withText("salah"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("salah@gmail.com"));

        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.loginEmail), withText("salah@gmail.com"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText11 = onView(
                allOf(withId(R.id.loginEmail),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText11.perform(replaceText("agung.sitepu@mis-mdo.sch.id"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText12 = onView(
                allOf(withId(R.id.loginPassword), withText("salah"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText17 = onView(
                allOf(withId(R.id.loginPassword), withText("123456"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText17.perform(replaceText("654321"));

        ViewInteraction appCompatEditText18 = onView(
                allOf(withId(R.id.loginPassword), withText("654321"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText20 = onView(
                allOf(withId(R.id.loginPassword), withText("654321"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText20.perform(replaceText("password"));
